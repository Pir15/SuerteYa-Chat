...
function listarChats($id){
    ...
    $string2=$id.",%";
    $string3="%,".$id;
    $query="SELECT c.idChat,c.tipo_chat,c.Nombre,c.fecha_creacion FROM usuarios u, chat c WHERE (c.id_usuarios LIKE '$string1' OR c.id_usuarios LIKE '$string2' OR c.id_usuarios LIKE '$string3')   AND u.id_usuario LIKE '$id'";

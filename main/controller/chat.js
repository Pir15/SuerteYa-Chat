    ...
    function(data) {
      ...
      if(data[3]!="" && data[3]!=null){
        ...
        if(data[4]=="INDIVIDUAL"){
          ...
          document.querySelector("#chatLogo").style.backgroundColor="#027f92";
          document.querySelector("#avatar").style="background-image:none;background-color:#027f92;color:white;font-size:1.5em";
        ...
        if(data[4]=="GRUPO"){
          ...
          document.querySelector("#añadirAdmin").style.display="block";
